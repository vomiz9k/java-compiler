...
void DoubleCallEliminateVisitor::Visit(AssertStatement *assert_statement) {
    tos_value_.statement_ = new AssertStatement(
            assert_statement->expression_
    );
}

void DoubleCallEliminateVisitor::Visit(PrintStatement *print_statement) {
    tos_value_.statement_ = new PrintStatement(
            print_statement->expression_
    );
}

void DoubleCallEliminateVisitor::Visit(MallocExpression *malloc_expression) {
    tos_value_.expression_ = new MallocExpression(
            malloc_expression->expression_
    );
};
