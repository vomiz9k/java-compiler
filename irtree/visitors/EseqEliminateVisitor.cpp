...
void EseqEliminateVisitor::Visit(AssertStatement *assert_statement) {

}

void EseqEliminateVisitor::Visit(PrintStatement *print_statement) {

}

void EseqEliminateVisitor::Visit(MallocExpression *malloc_expression) {
