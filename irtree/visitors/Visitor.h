...
public:
    ...
    virtual void Visit(MallocExpression *mem_expression) = 0;
    ...
    virtual void Visit(PrintStatement *print_expression) = 0;
    virtual void Visit(AssertStatement *print_expression) = 0;
};
};
